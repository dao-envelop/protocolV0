...
def test_set_price(accounts,  launcpad, distributor, dai, niftsy20):
    ...
    assert launcpad.getWNFTPrice(1, dai) == distributor.getERC20CollateralBalance(1, niftsy20) * launcpad.priceForOneCollateralUnit(dai)[0]/launcpad.priceForOneCollateralUnit(dai)[1]
