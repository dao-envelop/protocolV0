...
def test_check_reward(accounts,  farming, niftsy20):
    ...
    assert collateral + farming.getRewardSettings(niftsy20)[1][1]*collateral/10000 == farming.getERC20CollateralBalance(1, niftsy20)
